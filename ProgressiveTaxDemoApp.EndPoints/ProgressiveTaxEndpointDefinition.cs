...
public class ProgressiveTaxEndpointDefinition : IEndpointDefintion
{
    ...
    public void DefineServices(IServiceCollection services)
        => services.AddSingleton<IProgressiveTaxRepository, ProgressiveTaxRepository>();


    internal static async Task<IResult<int>> CreateAsync(IProgressiveTaxRepository _repository, ProgressiveTaxModel model)
    ...
    internal static async Task<IResult> DeleteAsync(IProgressiveTaxRepository _repository, int id)
