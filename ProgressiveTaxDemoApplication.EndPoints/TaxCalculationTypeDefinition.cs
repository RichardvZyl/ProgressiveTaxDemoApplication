...
public class TaxCalculationTypeDefintion : IEndpointDefintion
{
    ...
    public void DefineEndpoints(WebApplication app)
    {
        ...
        _ = app.MapPost($"{ControllerEndpoint}/{{taxCalculationType:TaxCalculationType}}", _service.CreateAsync)
    ...
    //public void DefineServices(IServiceCollection services) => services.AddSingleton<ITaxCalculationTypeRepository, TaxCalculationTypeRepository>();
}
